...
# Saving as pdf
pdf("all_analyses/cont/sd_mean/plot.pdf"); plot(obj, fsize = c(0.4,1), 
                     outline = FALSE, lwd = c(3,7), 
...
# Saving as pdf
pdf("all_analyses/cont/sd_mean/plot_log.pdf"); plot(obj.log, fsize = c(0.4, 0.8), 
                     outline = FALSE, lwd = c(3, 7), 
...
# Saving as pdf
pdf("all_analyses/cont/sd_mean/plot_subset.pdf"); plot(obj, fsize = c(0.4,1), 
                                                outline = FALSE, lwd = c(3,7), 
                                                leg.txt = "sd_mean"); dev.off()
